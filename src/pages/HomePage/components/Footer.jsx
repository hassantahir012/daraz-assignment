        ...
        <div className="row">
          <div className="col-12 col-md-6 p-0 footer-third-col-1">
            ...
            <div className="drz-footer-about">
              ...
              <div className="footer-third-col-content">
                ...
                across Asia in Pakistan, Bangladesh, Sri Lanka, Myanmar, and
                Daraz.com.np. Our vision was to provide a safe, efficient online
                marketplace platform for vendors and customers across the
                ...
                Daraz prides itself on not being just another ecommerce venture
            ...
            <div className="drz-footer-about">
              ...
              <div className="footer-third-col-content">
                ...
                offers its customers the most comprehensive listing of products
                ...
                both major and smaller cities alike, and give you the choice to
                track your package as it makes its way to you so you always know
                your order status. If you are unsatisfied with any aspect of
                ...
                for cash on delivery or even go for EMI (easy monthly
                instalments). You can also avail exclusive offers by downloading
                Daraz Wallet – a closed loop digital wallet that offers you a
            ...
            <div className="drz-footer-about">
              ...
              <div className="footer-third-col-content">
                ...
                with Daraz Global collection. Get the chance to shop online from
                ...
                avail exclusive online-only promotional packages as well as
                discount vouchers from our vendors when you shop from their
                pages. Our flash sales give you customized product offers all
                ...
                needs. We’re proud to be working with some of the most
                prestigious organizations in Pakistan across a number of
          ...
          <div className="col-6 col-md-3 p-0">
            <div className="drz-footer-top-category drz-footer-category-left">
              ...
              <div className="drz-footer-category-division">
                <h4 className="drz-footer-title-small">
                  <span>SHOP WORLDWIDE WITH LAZADA</span>
                </h4>
                <a className="drz-footer-category-tag" href="">
                  Singapore
                </a>
          ...
          <div className="col-6 col-md-3 p-0">
            <div className="drz-footer-top-category drz-footer-category-right">
              <div className="drz-footer-category-division">
                <h4 className="drz-footer-title-small">
